...
class LocationCalculatorCurved extends LocationCalculator{
    ...
    private final static double DEFAULT_SETPOINT_DISTANCE = 0.8;
    ...
    public double[] getDistanceDirection() {
        ...
        // Calculates how much of the original distance to the destination has been traveled
        // Value between 0 and 1
        ...
        // A point on the original vector from the starting position to the destination
        // It is the correspoindingOriginalPoint multiplied by a scaling factor, setPointDistance
